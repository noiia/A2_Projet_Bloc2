...
namespace A2ProjetBloc2 {
	...
	private: System::Windows::Forms::Label^ LbCompagnyName;
		   bool addOredit;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->TbCompagnyName = (gcnew System::Windows::Forms::TextBox());
			this->LbCompagnyName = (gcnew System::Windows::Forms::Label());
			this->SuspendLayout();
			// 
			// Title
			// 
			...
			this->TbFirstName->Size = System::Drawing::Size(315, 26);
			...
			this->TbPostalCodeBilling->Size = System::Drawing::Size(315, 26);
			...
			this->TbLastName->Size = System::Drawing::Size(315, 26);
			...
			this->CbCompany->Margin = System::Windows::Forms::Padding(4);
			this->CbCompany->Name = L"CbCompany";
			this->CbCompany->Size = System::Drawing::Size(203, 24);
			...
			this->DtpBirthdate->Size = System::Drawing::Size(315, 26);
			...
			this->TbNumberBilling->Size = System::Drawing::Size(315, 26);
			...
			this->TbStreetBilling->Size = System::Drawing::Size(315, 26);
			...
			this->TbNumberDelivery->Size = System::Drawing::Size(315, 26);
			...
			this->TbStreetDelivery->Size = System::Drawing::Size(315, 26);
			...
			this->TbPostalCodeDelivery->Size = System::Drawing::Size(315, 26);
			...
			this->tbCityDelivery->Size = System::Drawing::Size(315, 26);
			...
			this->tbCityBilling->Size = System::Drawing::Size(315, 26);
			...
			this->tbAdditionDelivery->Size = System::Drawing::Size(315, 26);
			...
			this->tbAdditionBilling->Size = System::Drawing::Size(315, 26);
			this->tbAdditionBilling->TabIndex = 54;
			// 
			// TbCompagnyName
			// 
			this->TbCompagnyName->Font = (gcnew System::Drawing::Font(L"Orkney", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->TbCompagnyName->Location = System::Drawing::Point(16, 296);
			this->TbCompagnyName->Name = L"TbCompagnyName";
			this->TbCompagnyName->Size = System::Drawing::Size(315, 26);
			this->TbCompagnyName->TabIndex = 56;
			// 
			// LbCompagnyName
			// 
			this->LbCompagnyName->AccessibleRole = System::Windows::Forms::AccessibleRole::None;
			this->LbCompagnyName->AutoSize = true;
			this->LbCompagnyName->Font = (gcnew System::Drawing::Font(L"Orkney", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->LbCompagnyName->Location = System::Drawing::Point(12, 274);
			this->LbCompagnyName->Name = L"LbCompagnyName";
			this->LbCompagnyName->Size = System::Drawing::Size(138, 19);
			this->LbCompagnyName->TabIndex = 55;
			this->LbCompagnyName->Text = L"Nom d\'entreprise";
			// 
			// AddClient
			// 
			...
			this->Controls->Add(this->LbCompagnyName);
...
#pragma endregion
	...
	private: System::Void CbCompany_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
		if (CbCompany->Checked) {
			TbCompagnyName->Enabled = true;
			DtpBirthdate->Enabled = false;
		}
		else if (CbCompany->Checked == false) {
			TbCompagnyName->Enabled = false;
	...
	private: System::Void BtnAddClient_Click(System::Object^ sender, System::EventArgs^ e) {
		if (this->CbCompany->Checked) {
			...
			this->client->setCompanyName(this->TbCompagnyName->Text);
