...
namespace A2ProjetBloc2 {
	...
	private:System::Windows::Forms::Label^ LbNumber;
		   ...
		   System::Windows::Forms::CheckBox^ CboxSupervisor;
...
#pragma endregion
	...
	private: System::Void BtnAddStaff_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->staff->setNameCity(this->TbCity->Text);
		this->staff->setNumber(this->TbNumber->Text);
		this->staff->setNameStreet(this->TbStreetName->Text);
		this->staff->setPostalCode(this->TbPostalCode->Text);
		this->staff->setAddition(this->TbAddressComplementary->Text);
